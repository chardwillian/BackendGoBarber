...
describe('CreateAppointment', () => {
    ...
    it('should be able to create a new appointment', async () => {
        jest.spyOn(Date, 'now').mockImplementationOnce(() => {
            // getTime pois retornaria apenas o timestamp e precisamos que retorne no tipo number
            return new Date(2021, 4, 10, 12).getTime(); // o número 4 representa o mês 5(maio) sempre confundo kk
        });
